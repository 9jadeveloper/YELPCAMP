...
var { isLoggedIn, checkCommentAuth, checkCampgroundAuth, isAdmin, isSafe } = middleware; // destructuring assignment
...
router.get("/:id/edit", isLoggedIn, checkCampgroundAuth, function(req, res){
...
router.delete("/:id", isLoggedIn, checkCampgroundAuth, function(req, res) {
    Comment.remove({
      _id: {
